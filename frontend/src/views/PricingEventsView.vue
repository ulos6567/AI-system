...
.ev-table th, .ev-table td { padding: 0.55rem 0.5rem; text-align: left; border-bottom: 1px solid #eef3f8; vertical-align: top; }
.ev-table th { background: #f6f9fc; color: #3f5069; font-weight: 600; }
.ev-table .num { text-align: right; font-variant-numeric: tabular-nums; }
.ev-table .strong { font-weight: 700; color: #047857; }
.ev-table .muted { color: #8a99af; }
.ev-table .small { font-size: 0.78rem; }
.prod { font-weight: 500; }
.cat { font-size: 0.75rem; color: #8a99af; }
...
button.ghost { background: #fff; color: #0d253d; border: 1px solid #c7d2e0; padding: 0.45rem 0.85rem; border-radius: 6px; cursor: pointer; }
</style>
